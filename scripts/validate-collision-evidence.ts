...
if (JSON.stringify(files) !== JSON.stringify(expectedFiles)) throw new Error('Generated SVG directory does not match the canonical 28-asset manifest');
...
const expectedSources: Record<string, string[]> = {
  ...
  'page-light-desktop.png': ['hero-light.svg', 'systems-light.svg', 'architecture-light.svg', 'signal-light.svg'],
  'page-dark-mobile.png': ['hero-dark.svg', 'systems-mobile-dark.svg', 'architecture-mobile-dark.svg', 'signal-mobile-dark.svg'],
  'page-light-mobile.png': ['hero-light.svg', 'systems-mobile-light.svg', 'architecture-mobile-light.svg', 'signal-mobile-light.svg'],
  ...
  'page-intermediate-light.png': ['hero-light.svg', 'systems-mobile-light.svg', 'architecture-mobile-light.svg', 'signal-mobile-light.svg'],
};
