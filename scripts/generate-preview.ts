...
${profileImage('hero', 'Hakan Duyar circular identity field with Flight, Signal, and Spatial modes.', true)}${profileImage('systems', 'Four selected systems arranged on a connected engineering path.', true, true)}<details class="profile-details"><summary><picture><source media="(max-width: 1080px)" srcset="../assets/generated/expand-mobile-dark.svg"><img class="expand-visual" src="../assets/generated/expand-dark.svg" alt="Show architecture and public signal" width="95%" align="middle"></picture></summary>${profileImage('architecture', 'Interface, state, services, and delivery shown as spatial architecture layers.', true, true)}${profileImage('signal', 'Measured 52-week public contribution signal and language distribution.', true, true)}</details>
</div></article>
